...
import {
  X, MapPin, DollarSign, Eye, Heart, MessageSquare, ExternalLink,
  Sparkles, CheckCircle2, Calendar, User, ChevronLeft, ChevronRight
} from 'lucide-react';
        ...
        <div className="relative min-h-screen flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="grid lg:grid-cols-2 max-h-[90vh]">
              {/* Left: Image */}
              <div className="relative bg-muted lg:sticky lg:top-0 lg:h-[90vh]">
